            ...
            <nav class="navbar navbar-default">
              ...
              <div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse">
                <ul id="top-menu" class="nav navbar-nav navbar-right">
                  ...
                  <li><a href="#">{{ $t('links.teacherslogin') }}</a></li>
...
<!--                    </NuxtLink>-->
                  ...
                  <li v-else @click="changeToAr"><a>{{ $t('links.arabic')}}</a></li>
                </ul>
              </div>
              <!-- /.navbar-collapse -->
            </nav>
    ...
    <div class="main-content">
      ...
      <section class="overview-block-ptb grey-bg iq-great-feature">
        <div class="container">
          <div class="row">
            <div class="col-sm-12">
              <div class="heading-title">
    ...
    <div class="footer">
      ...
      <section id="contact-us" class="iq-our-touch iq-mt-100">
        <div class="container">
            ...
            <div class="row">
                ...
                <form id="contactform" class="form-horizontal" method="post" action="../php/contact-form.php">
                  <div class="contact-form">
                    ...
                    <div class="section-field textarea">
                      <textarea class="input-message" v-bind:placeholder="$t('contact.message')" rows="6" name="message" />
                    </div>
              ...
              <div class="col-sm-12 col-md-6 col-lg-6 re-mt-30">
                <div class="contact-info iq-pall-60 iq-pt-0">
                  ...
                  <v-row class="iq-fancy-box-02 iq-mt-40 iq-ml-10">
                    <div class="iq-icon green-bg">
          ...
          <div class="row iq-ptb-60">
            ...
            <div class="col-sm-12">
              <form class="form-inline iq-subscribe">
                <div class="form-group">
                  <input id="exampleInputName2" type="text" class="form-control" v-bind:placeholder=" $t('intro.emailaddess') ">
                </div>
    ...
    <div id="back-to-top">
      <a class="top" href="#top"> <i class="ion-ios-upload-outline" /> </a>
    </div>
  </div>
</template>
