...
+(function (t) {
  ...
  function e (e) {
    return this.each(function () {
      const i = t(this)
      let n = i.data('bs.alert')
      n || i.data('bs.alert', (n = new o(this))),
      typeof e === 'string' && n[e].call(i)
    })
  }
...
+(function (t) {
  ...
  (i.prototype.setState = function (e) {
    ...
    const n = o.is('input') ? 'val' : 'html'
    const s = o.data()
        ;(e += 'Text'),
    s.resetText == null && o.data('resetText', o[n]()),
    setTimeout(
      t.proxy(function () {
        o[n](s[e] == null ? this.options[e] : s[e]),
        e == 'loadingText'
          ? ((this.isLoading = !0),
  ...
  t(document)
    .on('click.bs.button.data-api', '[data-toggle^="button"]', function (
      ...
      const o = t(i.target).closest('.btn')
      e.call(o, 'toggle'),
...
+(function (t) {
  ...
  function e (e) {
    return this.each(function () {
      const o = t(this)
      let n = o.data('bs.carousel')
      const s = t.extend({}, i.DEFAULTS, o.data(), typeof e === 'object' && e)
  ...
  (i.prototype.slide = function (e, o) {
    const n = this.$element.find('.item.active')
    const s = o || this.getItemForDirection(e, n)
    const a = this.interval
    const r = e == 'next' ? 'left' : 'right'
    const l = this
    if (s.hasClass('active')) { return (this.sliding = !1) }
    const h = s[0]
    const d = t.Event('slide.bs.carousel', { relatedTarget: h, direction: r })
    if ((this.$element.trigger(d), !d.isDefaultPrevented())) {
      if (
        ((this.sliding = !0), a && this.pause(), this.$indicators.length)
      ) {
        this.$indicators.find('.active').removeClass('active')
        const p = t(this.$indicators.children()[this.getItemIndex(s)])
        p && p.addClass('active')
      }
      const c = t.Event('slid.bs.carousel', {
        relatedTarget: h,
        direction: r
      })
      return (
  ...
  const n = function (i) {
    ...
    if (s.hasClass('carousel')) {
      const a = t.extend({}, s.data(), n.data())
      const r = n.attr('data-slide-to')
      r && (a.interval = !1),
      e.call(s, a),
...
+(function (t) {
  ...
  function o (e) {
    return this.each(function () {
      const i = t(this)
      let o = i.data('bs.dropdown')
      o || i.data('bs.dropdown', (o = new a(this))),
      typeof e === 'string' && o[e].call(i)
    })
  }
  ...
  (a.prototype.keydown = function (i) {
    if (
      ...
      if (
        ...
        const n = e(o)
        const a = n.hasClass('open')
        if ((!a && i.which != 27) || (a && i.which == 27)) {
          return (
            i.which == 27 && n.find(s).trigger('focus'), o.trigger('click')
          )
        }
        const r = ' li:not(.disabled):visible a'
        const l = n.find('.dropdown-menu' + r)
        if (l.length) {
          let h = l.index(i.target)
          i.which == 38 && h > 0 && h--,
          i.which == 40 && h < l.length - 1 && h++,
          ~h || (h = 0),
...
+(function (t) {
  ...
  function e (e, o) {
    return this.each(function () {
      const n = t(this)
      let s = n.data('bs.modal')
      const a = t.extend({}, i.DEFAULTS, n.data(), typeof e === 'object' && e)
      s || n.data('bs.modal', (s = new i(this, a))),
      typeof e === 'string' ? s[e](o) : a.show && s.show(o)
    })
  }
  var i = function (e, i) {
    ;(this.options = i),
  ...
  (i.prototype.show = function (e) {
    const o = this
    const n = t.Event('show.bs.modal', { relatedTarget: e })
    ...
    this.isShown ||
            ...
            this.backdrop(function () {
              const n = t.support.transition && o.$element.hasClass('fade')
              ...
              o.enforceFocus()
              const s = t.Event('shown.bs.modal', { relatedTarget: e })
              n
                ? o.$dialog
                  .one('bsTransitionEnd', function () {
  ...
  (i.prototype.backdrop = function (e) {
    const o = this
    const n = this.$element.hasClass('fade') ? 'fade' : ''
    if (this.isShown && this.options.backdrop) {
      const s = t.support.transition && n
      if (
...
+(function (t) {
  ...
  (i.prototype.init = function (e, i, o) {
    ...
    for (let n = this.options.trigger.split(' '), s = n.length; s--;) {
      ...
      if (a == 'click') {
        ...
        const r = a == 'hover' ? 'mouseenter' : 'focusin'
        const l = a == 'hover' ? 'mouseleave' : 'focusout'
        this.$element.on(
          r + '.' + this.type,
          this.options.selector,
  ...
  (i.prototype.show = function () {
    ...
    if (this.hasContent() && this.enabled) {
      ...
      const p = s[0].offsetWidth
      const c = s[0].offsetHeight
      if (h) {
        const f = r
        const u = this.getPosition(this.$viewport)
            ;(r =
              r == 'bottom' && d.bottom + c > u.bottom
                ? 'top'
                : r == 'top' && d.top - c < u.top
                  ? 'bottom'
                  : r == 'right' && d.right + p > u.width
                    ? 'left'
                    : r == 'left' && d.left - p < u.left
                      ? 'right'
                      : r),
        s.removeClass(f).addClass(r)
      }
      const g = this.getCalculatedOffset(r, d, p, c)
      this.applyPlacement(g, r)
      const v = function () {
        const t = n.hoverState
  ...
  (i.prototype.applyPlacement = function (e, i) {
    const o = this.tip()
    const n = o[0].offsetWidth
    const s = o[0].offsetHeight
    let a = parseInt(o.css('margin-top'), 10)
    let r = parseInt(o.css('margin-left'), 10)
    isNaN(a) && (a = 0),
    isNaN(r) && (r = 0),
    (e.top += a),
    (e.left += r),
    ...
    o.addClass('in')
    const l = o[0].offsetWidth
    const h = o[0].offsetHeight
    i == 'top' && h != s && (e.top = e.top + s - h)
    const d = this.getViewportAdjustedDelta(i, e, l, h)
    d.left ? (e.left += d.left) : (e.top += d.top)
    const p = /top|bottom/.test(i)
    const c = p ? 2 * d.left - n + l : 2 * d.top - s + h
    const f = p ? 'offsetWidth' : 'offsetHeight'
  ...
  (i.prototype.hide = function (e) {
    ...
    var n = this
    var s = t(this.$tip)
    const a = t.Event('hide.bs.' + this.type)
    return (
  ...
  (i.prototype.getPosition = function (e) {
    ...
    const a = o ? { top: 0, left: 0 } : s ? null : e.offset()
    const r = {
      scroll: o
  ...
  (i.prototype.getTitle = function () {
    ...
    return (t =
          ...
          (typeof i.title === 'function' ? i.title.call(e[0]) : i.title))
  }),
...
+(function (t) {
  ...
  function e (e) {
    return this.each(function () {
      const o = t(this)
      let n = o.data('bs.tab')
      n || o.data('bs.tab', (n = new i(this))), typeof e === 'string' && n[e]()
    })
  }
  var i = function (e) {
    this.element = t(e)
  ...
  (i.prototype.show = function () {
    const e = this.element
    const i = e.closest('ul:not(.dropdown-menu)')
    let o = e.data('target')
    if (
      (o ||
      ...
      const n = i.find('.active:last a')
      const s = t.Event('hide.bs.tab', { relatedTarget: e[0] })
      const a = t.Event('show.bs.tab', { relatedTarget: n[0] })
      if (
        (n.trigger(s),
        e.trigger(a),
...
+(function (t) {
  ...
  (i.prototype.getState = function (t, e, i, o) {
    ...
    if (i != null && this.affixed == 'top') { return i > n ? 'top' : !1 }
  ...
  (i.prototype.checkPosition = function () {
    if (this.$element.is(':visible')) {
      ...
      let n = o.top
      let s = o.bottom
      const a = Math.max(t(document).height(), t(document.body).height())
      typeof o !== 'object' && (s = n = o),
      typeof n === 'function' && (n = o.top(this.$element)),
      typeof s === 'function' && (s = o.bottom(this.$element))
      const r = this.getState(a, e, n, s)
      if (this.affixed != r) {
        this.unpin != null && this.$element.css('top', '')
        const l = 'affix' + (r ? '-' + r : '')
        const h = t.Event(l + '.bs.affix')
        if ((this.$element.trigger(h), h.isDefaultPrevented())) {
          return
        }(this.affixed = r),
        (this.unpin = r == 'bottom' ? this.getPinnedOffset() : null),
        this.$element
          .removeClass(i.RESET)
          .addClass(l)
          .trigger(l.replace('affix', 'affixed') + '.bs.affix')
      }
      r == 'bottom' && this.$element.offset({ top: a - e - s })
    }
  })
  const o = t.fn.affix
    ;(t.fn.affix = e),
  ...
  t(window).on('load', function () {
    t('[data-spy="affix"]').each(function () {
      ...
      const o = i.data()
          ;(o.offset = o.offset || {}),
      o.offsetBottom != null && (o.offset.bottom = o.offsetBottom),
      o.offsetTop != null && (o.offset.top = o.offsetTop),
      e.call(i, o)
    })
  })
})(jQuery),
+(function (t) {
  ...
  function i (e) {
    return this.each(function () {
      const i = t(this)
      let n = i.data('bs.collapse')
      const s = t.extend({}, o.DEFAULTS, i.data(), typeof e === 'object' && e)
    ...
    if (!this.transitioning && !this.$element.hasClass('in')) {
      ...
      if (
        ...
        if ((this.$element.trigger(s), !s.isDefaultPrevented())) {
          ...
          const l = t.camelCase(['scroll', a].join('-'))
          this.$element
...
+(function (t) {
  ...
  function i (i) {
    return this.each(function () {
      const o = t(this)
      let n = o.data('bs.scrollspy')
      const s = typeof i === 'object' && i
  ...
  (e.prototype.refresh = function () {
    ...
    this.$body
      ...
      .map(function () {
        const e = t(this)
        const n = e.data('target') || e.attr('href')
        const s = /^#./.test(n) && t(n)
        return (
  ...
  (e.prototype.activate = function (e) {
    ...
    const i =
            ...
            e +
            '"]'
    let o = t(i).parents('li').addClass('active')
...
+(function (t) {
  ...
  function e () {
    ...
    for (const i in e) { if (void 0 !== t.style[i]) { return { end: e[i] } } }
    return !1
  }
