...
!(function (a, b) {
  ...
  ;(n.ready.promise = function (b) {
    if (!I) {
      ...
      ) { a.setTimeout(n.ready) } else if (d.addEventListener) { d.addEventListener('DOMContentLoaded', K), a.addEventListener('load', K) } else {
  ...
  function ja (a, b, c, d, e) {
    ...
    (r = 0)
    while ((g = q[r++])) {
      if (d && n.inArray(g, d) > -1) { e && e.push(g) } else if (
 ...
 try {
    ...
    ajax (b, c) {
      ...
      var w = {
        ...
        statusCode (a) {
          let b
          if (a) {
            if (u < 2) { for (b in a) { r[b] = [r[b], a[b]] } } else { w.always(a[w.status]) }
          }
          return this
        },
        abort (a) {
  ...
  function dc (a, b, c, d) {
    ...
    } else if (c || n.type(b) !== 'object') { d(a, b) } else { for (e in b) { dc(a + '[' + e + ']', b[e], c, d) } }
  }
