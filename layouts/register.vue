                    ...
                    >
                      <v-list-item class="mt-8">
                        <v-list-item-content>
                          ...
                          <v-list-item-subtitle>{{ $t('register.o_register2') }}</v-list-item-subtitle>
                        </v-list-item-content>
                      </v-list-item>
                      <v-form>
                        <v-autocomplete
                          ...
                          v-model="governate"
                          class="mx-4 mt-8"
                          :rules="[() => !!governate || $t('register.required')]"
                          :items="govEn"
                    ...
                    >
                      <v-list-item class="mt-8">
                        <v-list-item-content>
                          ...
                          <v-list-item-subtitle>{{ $t('register.o_register3') }}</v-list-item-subtitle>
                        </v-list-item-content>
                      </v-list-item>
                      <v-form>
                        <v-autocomplete
                          ...
                          v-model="experience"
                          class="mx-4 mt-8"
                          :rules="[() => !!experience || $t('register.required') ]"
                        ...
                        <v-autocomplete
                          ...
                          v-model="speciality"
                          class="mx-4 "
                          :rules="[() => !!speciality || $t('register.required')]"
                          :items="['Skiing', 'Ice hockey', 'Soccer', 'Basketball', 'Hockey', 'Reading', 'Writing', 'Coding', 'Basejump']"
...
export default {
  data () {
    return {
      govEn: ['Alexandria', 'Aswan', 'Asyut', 'Beheira', 'Beni Suef', 'Cairo', 'Dakahlia', 'Damietta', 'Faiyum', 'Gharbia', 'Giza', 'Ismailia', 'Kafr El Sheikh', 'Luxor', 'Matruh', 'Minya', 'Monufia', 'New Valley', 'North Sinai', 'Port Said', 'Qalyubia', 'Qena', 'Red Sea', 'Sharqia', 'Sohag', 'South Sinai', 'Suez'],
      showPassword: false,
      e1: 1,
      steps: 3
    }
